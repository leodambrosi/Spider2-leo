...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Convert agent results to Spider 2.0 submission format.")
    parser.add_argument("--all_results_path", type=str, default="output", help="Root result directory")
    parser.add_argument("--experiment_suffix", type=str, default="deepseek-dspy", help="Experiment suffix (subdirectory name)")
    parser.add_argument("--results_folder_name", type=str, default="../../spider2-lite/evaluation_suite/deepseek-dspy", help="Directory to save submission files")
